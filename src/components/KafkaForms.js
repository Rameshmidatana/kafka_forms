        ...
        inputGroups.map((inputGroup,index)=>(
          ...
          <Grid item xs={5} md={5}>
            <FormControl fullWidth>
              <TextField id="outlined-basic" label={"Type Code "+index} variant="outlined" size="small" value={inputGroups[index].title} onChange={(e)=>handleTitleUpdate(index,e)}/>
            </FormControl>
          </Grid>
          <Grid item xs={5} md={5}>
            <FormControl fullWidth>
              <TextField id="outlined-basic" label={"Type Description "+index} variant="outlined" size="small" value={inputGroups[index].description} onChange={(e)=>handleDescriptionUpdate(index,e)}/>
            </FormControl>
          </Grid>
          <Grid item xs={2} md={2}>
